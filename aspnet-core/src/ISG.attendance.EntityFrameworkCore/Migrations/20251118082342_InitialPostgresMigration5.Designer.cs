...
namespace ISG.attendance.Migrations
{
    ...
    [Migration("20251118082342_InitialPostgresMigration5")]
    partial class InitialPostgresMigration5
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ISG.attendance.Entities.Attendance", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ISG.attendance.Entities.CompanySettings", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("EarlyCheckOutGracePeriodMinutes")
                    ...
                    b.Property<int>("LateCheckInGracePeriodMinutes")
                        .HasColumnType("integer");

                    b.Property<double>("NormalWorkingHours")
                        .HasColumnType("double precision");
                    ...
                    b.ToTable("AppCompanySettings", (string)null);
                });

            modelBuilder.Entity("ISG.attendance.Entities.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ISG.attendance.Entities.Location", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ISG.attendance.Entities.Attendance", b =>
                {
                    b.HasOne("ISG.attendance.Entities.Employee", "Employee")
                        .WithMany()
            ...
            modelBuilder.Entity("ISG.attendance.Entities.Employee", b =>
                {
                    b.HasOne("ISG.attendance.Entities.Location", "Location")
                        .WithMany()
